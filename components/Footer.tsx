    ...
    <footer className="bg-secondary text-white mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-lg font-bold mb-4">About D2D</h3>
            <p className="text-sm text-gray-300">
              Dare2Discover brings you authentic Saudi experiences.
              Book verified tours and explore the Kingdom's culture and beauty.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/tours" className="text-gray-300 hover:text-primary">All Tours</Link></li>
              <li><Link href="/experiences" className="text-gray-300 hover:text-primary">Experiences</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/booking-policy" className="text-gray-300 hover:text-primary">Booking Policy</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li>Email: info@d2d-saudi.com</li>
