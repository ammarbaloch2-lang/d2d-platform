              ...
              <div className="flex flex-wrap gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`bg-gray-100 text-gray-700 p-3 rounded-full transition-all duration-300 hover:text-white ${social.color} hover:scale-110 shadow-md hover:shadow-lg`}
      ...
      <section className="bg-sand-light py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="rounded-lg overflow-hidden shadow-xl">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3628.746845575742!2d46.64513897536143!3d24.56340887812446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjTCsDMzJzQ4LjMiTiA0NsKwMzgnNTEuOCJF!5e0!3m2!1sen!2ssa!4v1761302521316!5m2!1sen!2ssa"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
